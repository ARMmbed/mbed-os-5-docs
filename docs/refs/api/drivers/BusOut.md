...
Use the BusOut interface to create a number of [DigitalOut](DigitalOut.md) pins that you can write as one value. This API is useful for writing multiple outputs in a single pass. You can use this API to write clearer code faster. 
