...
The managed and unmanaged bootloader builds require some target metadata from CMSIS Packs. Add a `"device_name"` attribute to your target as [Adding and configuring targets](/docs/v5.10/tools/adding-and-configuring-targets.html) describes.
