...
<span class="tips">**Tip:** See the documentation of the [Arm Mbed configuration system](https://os.mbed.com/docs/v5.4/porting/the-arm-mbed-configuration-system.html) for more details about `mbed_app.json`. </span>
