...
Mbed OS 5 can be built with various toolchains. Make sure you are using the latest versions of the toolchains. You can find the currently supported versions on [our tools page](https://os.mbed.com/docs/v5.8/tools/index.html).
...
- Build using the development or [debug build profile](https://os.mbed.com/docs/v5.8/tools/build-profiles.html), so the serial port shows any errors in your program.
