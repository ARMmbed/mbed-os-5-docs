...
1. In the *Debugger* tab:
    ...
    - Under *OpenOCD Setup*, set the *Config options* to the setup options from the [Configure your local debug toolchain](https://os.mbed.com/docs/v5.8/tools/exporting.html) guide.
