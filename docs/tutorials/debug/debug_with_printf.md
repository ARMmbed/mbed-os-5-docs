...
- For all other boards: [Arm Mbed Windows serial port driver](/docs/v5.9/tutorials/windows-serial-driver.html) - not required for Windows 10.
...
To send data over the serial connection, use the [Serial](/docs/v5.9/reference/serial.html) object.
...
Your board crashes when you press the button because [mutexes guard](https://os.mbed.com/docs/v5.9/reference/mutex.html) calls to stdio functions, such as printf, in the Arm C standard library, and mutexes [cannot be called from an ISR](https://www.keil.com/pack/doc/cmsis/RTOS/html/group__CMSIS__RTOS__MutexMgmt.html).

You can avoid this by:

- Signaling from the ISR to the main thread using a [semaphore](https://os.mbed.com/docs/v5.9/reference/semaphore.html) or [mailbox](https://os.mbed.com/docs/v5.9/reference/mail.html), and calling `printf` in the main thread.
- Using an event dispatching library, such as [Mbed events](https://os.mbed.com/docs/v5.9/reference/event.html).
