...
- [Mbed CLI](/docs/v5.10/tools/developing-mbed-cli.html).
...
To update to Mbed OS 5 with the [Mbed CLI](/docs/v5.10/tools/developing-mbed-cli.html), run:
...
To update to Mbed OS 5 with the [Mbed Online Compiler](/docs/v5.10/tools/developing-mbed-online-compiler.html):
