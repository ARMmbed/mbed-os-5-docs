...
To migrate from Mbed OS 2 to Mbed OS 5, [please follow our migration tutorial](/docs/development/tutorials/migrationg-to-mbed-os-5.html).
...
**Do Mbed OS 2 and Mbed OS 5 use the same header file?**
   ...
   If you want to learn more about how these configuration files work, please see [our configuration documentation](/docs/development/tools/configuring-tools.html).
