...
**Do Mbed OS 2 and Mbed OS 5 use the same header file?**
   ...
   If you want to learn more about how these configuration files work, please see [our configuration documentation](/docs/5.8/tools/configuring-tools.html).
...
**Do Mbed OS 2 and Mbed OS 5 use the same documentation?**
   ...
   - [Mbed OS 5 documentation](https://os.mbed.com/docs/5.8).
