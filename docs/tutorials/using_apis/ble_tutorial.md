...
We have several BLE tutorials you can choose from.

<!--why are they on GitHub instead of part of the docs?-->
## Requirements
...
<span>**Tip:** Despite the differences between the different Mbed OS versions, there is only **one** version of Mbed BLE, and it is easy to move code from one version of the OS to another. Choose the sample you use according to the version of Mbed OS supported by your development board.</span><!--is this still true?-->

## Going further

- The Mbed BLE [API reference](../apis/ble.html) offers the full details of the API.

- The Mbed BLE [online community](https://os.mbed.com/teams/Bluetooth-Low-Energy/community/) is a great place to ask questions and share your knowledge.
