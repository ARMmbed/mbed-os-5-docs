...
Our quick start is [@amanda can you link to the current quick start? New one is for 5.11]
...
<span class="images">![](https://s3-us-west-2.amazonaws.com/mbed-os-docs-images/Mbed_OS_diagram_for_intro.png)<span>A sketch of a typical Mbed board's hardware architecture</span></span>
...
Arm, its Partners and the Arm Mbed developer community work together to develop the Mbed OS project. This thriving ecosystem means that most components already have Mbed OS drivers, so you can concentrate on clean and portable application code.
