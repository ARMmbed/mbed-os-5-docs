...
**Blinky** - An [example application](/docs/v5.7/tutorials/arm-mbed-os-quickstart.html) that you can use to get to know Arm Mbed OS and the development tools. It’s one of the simplest examples of Mbed OS.
