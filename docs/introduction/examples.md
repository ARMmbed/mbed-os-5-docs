...
[Use the generic Mbed border router and create a 6LoWPAN-ND network](https://os.mbed.com/teams/mbed-os-examples/code/mbed-os-example-mesh-minimal/). Your 6LoWPAN devices can access to internet using this gateway.
