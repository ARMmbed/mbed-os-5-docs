...
<span class="notes">**Note:** Keil Studio does not support this functionality. You need to use [Mbed CLI](../build-tools/mbed-cli-1.html) to take your code offline.</span>
