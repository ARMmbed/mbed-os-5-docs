...
<span class="tips">**Tip:** If you're working on Windows or macOS, we recommend using the installers for Mbed CLI:<br>- [Windows installer for Mbed CLI](https://github.com/ARMmbed/mbed-cli-windows-installer/releases/latest).<br>- [macOS installer for Mbed CLI](https://github.com/ARMmbed/mbed-cli-osx-installer/releases/latest).<br>For details, please see our [documentation for the Windows installer for Mbed CLI](installing-with-the-windows-installer.html) and our [documentation for macOS installer for Mbed CLI](installing-with-the-macos-installer.html).</span>
