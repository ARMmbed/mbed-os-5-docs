...
Tests can also be completely ignored by using the `.mbedignore` file described [here](/docs/v5.6/tools/ignoring-files-from-mbed-build.html).
...
You can build tests through Arm Mbed CLI. For information on using Mbed CLI, please see its [documentation](/docs/v5.6/tools/mbed-cli.html).
...
You can run automated tests through Mbed CLI. For information on using Mbed CLI, please see its [documentation](/docs/v5.6/tools/mbed-cli.html).
