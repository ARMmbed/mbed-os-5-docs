...
Tests can also be completely ignored by using the `.mbedignore` file described in the [documentation](/docs/development/tools/ignoring-files-from-mbed-build.html).
