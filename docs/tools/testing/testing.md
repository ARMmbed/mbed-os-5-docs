...
Tests can also be completely ignored by using the `.mbedignore` file described in the [documentation](/docs/v5.9/tools/ignoring-files-from-mbed-build.html).
...
You can build tests through Arm Mbed CLI. For information on using Mbed CLI, please see the [CLI documentation](/docs/v5.9/tools/arm-mbed-cli.html).
