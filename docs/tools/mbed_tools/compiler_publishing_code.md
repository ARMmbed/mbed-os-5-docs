...
If you want to share your work, click **Publish** from the right-click context menu in the mbed Online Compiler:

	<span class="images">![](images/publish.png)<span>Using the Online Compiler to publish a program</span></span>

If you have uncommitted changes, you will be prompted to commit your work. If this is the first time you have published this program or library, you will see a dialog box you need to complete.

	<span class="images">![](images/publish_deatils.png)<span>Completing the dialog box with a description of the program</span></span>

The **Publish in** option refers to your choice to publish your repository to your user account or to a team that you are a member of. When publishing to a team, all members of that team will be able to collaborate on your work with the permissions managed by the team as well as the repository.
...
**Visibility** controls who can see your repository. There are three options:
...
Copying your private repository to the mbed public website, where other users can import it, also copies a reference to any libraries you used in your code. If those libraries are not published, you will be prompted to publish them.
