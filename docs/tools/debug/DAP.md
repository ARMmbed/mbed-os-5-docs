...
The software project is complemented by a series of reference designs for creating the DAPLink debug probe hardware, which is available in the [HDK documentation](/docs/development/porting/porting-tools.html#arm-mbed-hdk).
