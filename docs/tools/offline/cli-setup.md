...
- `ARMC6_PATH`: The path to the *binary* directory of your Arm Compiler 6 installation. This should be the directory containing the directory containing the binaries for `armar` and friends. For example, if your Arm Compiler 6 executable `armar` is located at `C:/Program Files/ARM/armcc6.8/bin/armar`, you set `ARMC6_PATH` to `C:/Program Files/ARM/armcc6.8/bin`
