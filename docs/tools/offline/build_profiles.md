...
- Chip goes to sleep when idle:
    ...
    * Breaks the local file system on the [Arm Mbed interface](/docs/v5.7/introduction/index.html) on some boards.
...
- Chip goes to sleep when going idle:
    - Debugger is likely to drop connection.
    - Breaks the local file system on the [Mbed interface](/docs/v5.7/introduction/index.html) on some boards.
