...
The RTOS provides several mechanisms to move interrupt processing onto a thread. These include, but are not limited to:
 ...
 - [Queue](https://os.mbed.com/docs/v5.14/mbed-os-api-doxy/classrtos_1_1_queue.html).
 - [Mail](https://os.mbed.com/docs/v5.14/mbed-os-api-doxy/classrtos_1_1_mail.html).
...
For more information see [rtos/Mutex.h](https://os.mbed.com/docs/v5.14/mbed-os-api-doxy/_mutex_8h_source.html).
...
For more information see [platform/critical.h](https://os.mbed.com/docs/v5.14/mbed-os-api-doxy/critical_8h_source.html).
