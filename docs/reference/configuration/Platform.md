...
The platform configurations allow for customization of platform level OS options. Such options include error handling properties <!-- TOOD: Pending on https://github.com/ARMmbed/mbed-os/pull/7214 --> and serial communication configuration settings for STDIO which work out of platform as they affect system level printf calls, not Serial objects <!-- TODO: default-serial-baud-rate does affect Serial objects. That should be moved to drivers. Working on options for that. -->
