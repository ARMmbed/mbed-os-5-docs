...
For a detailed API reference for outgoing messages, please visit the [LoRaWANInterface API documentation](https://os-doc-builder.test.mbed.com/docs/v5.9/mbed-os-api-doxy/class_lo_ra_w_a_n_interface.html). Look for `send()` API. For example:
...
For detailed API reference for outgoing messages, please visit the [LoRaWANInterface API documentation](https://os-doc-builder.test.mbed.com/docs/v5.9/mbed-os-api-doxy/class_lo_ra_w_a_n_interface.html). Look for `receive()` APIs. 
