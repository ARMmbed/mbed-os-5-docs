...
Mbed OS already supports several Mbed Enabled boards with on-board cellular hosted modules. Because Mbed OS is an open source platform, developers can enable support for new cellular boards with our adaptation framework. Please see our [cellular porting guide](/docs/v5.10/porting/porting-connectivity.html#cellularinterface) for more information.
...
To read more about security, see [Arm Mbed TLS](/docs/v5.10/apis/tls.html).
