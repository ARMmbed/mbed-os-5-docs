...
See [Thread commissioning guide](/docs/development/reference/technology.html#thread-commissioning) how to commission a Thread device to the network in practice.
