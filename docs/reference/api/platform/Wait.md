...
When you call `wait`, your board's CPU is in a loop waiting for the required time to pass. Using the [Arm Mbed RTOS](/docs/v5.6/reference/rtos-api.html), you can make a call to `Thread::wait` instead.
