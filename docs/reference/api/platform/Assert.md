...
[![View code](https://www.mbed.com/embed/?type=library)](http://os-doc-builder.test.mbed.com/docs/v5.9/mbed-os-api-doxy/mbed__assert_8h_source.html)
...
Note that the `MBED_ASSERT` macro is available in the debug and develop [build profiles](/docs/v5.9/tools/build-profiles.html) but not in the release build profile.
...
- [Build profile](/docs/v5.9/tools/build-profiles.html) documentation.
