...
This is the technical reference for callbacks. You should read the [Callbacks](/docs/v5.9/reference/platform.html#callbacks) section of the [Platform Overview](/docs/v5.9/reference/platform.html) first for deeper insight into their use.

### Callback class reference

[![View code](https://www.mbed.com/embed/?type=library)](http://os-doc-builder.test.mbed.com/docs/v5.9/mbed-os-api-doxy/classmbed_1_1_callback_3_01_r_07_a0_00_01_a1_00_01_a2_00_01_a3_00_01_a4_08_4.html)
...
Here is an example that uses everything discussed in the [introduction to callbacks](/docs/v5.9/reference/platform.html#callbacks) document in the form of a minimal Sonar class. This example uses a C++ class and method in the Callback.
