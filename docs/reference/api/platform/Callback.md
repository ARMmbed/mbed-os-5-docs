...
This is the technical reference for callbacks. You should read the [introduction to callbacks](/docs/v5.4/reference/platform-overview.html#callbacks) first to understand how to use them.

### Callback class reference

[![View code](https://www.mbed.com/embed/?type=library)](https://os.mbed.com/docs/v5.4/mbed-os-api-doxy/classmbed_1_1_callback.html)
