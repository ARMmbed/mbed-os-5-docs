...
<span class="images">![](https://os-doc-builder.test.mbed.com/docs/v5.9/mbed-os-api-doxy/classmbed_1_1_interrupt_in.png)<span>InterruptIn class hierarchy</span></span>
...
[![View code](https://www.mbed.com/embed/?type=library)](http://os-doc-builder.test.mbed.com/docs/v5.9/mbed-os-api-doxy/classmbed_1_1_interrupt_in.html)
...
* For `printfs` from interrupt context, use [Event](/docs/v5.9/reference/event.html) instead.

### Related

To read an input, see [DigitalIn](/docs/v5.9/reference/digitalin.html).
...
- [Event](/docs/v5.9/reference/event.html) API reference.
- [DigitalIn](/docs/v5.9/reference/digitalin.html) API reference.
