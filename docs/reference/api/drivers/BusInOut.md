...
Use the BusInOut interface as a bidirectional bus that supports up to 16 [DigitalInOut](/docs/v5.6/reference/api-references.html#digitalinout) pins that you can read and write as one value.
