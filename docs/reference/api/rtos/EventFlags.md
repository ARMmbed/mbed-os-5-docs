...
You can find the Arm Mbed OS EventFlags wrapper source code in the <a href="https://github.com/ARMmbed/mbed-os/blob/master/rtos/EventFlags.h" target="_blank">Mbed OS repository</a>.
