...
<span class="images">![](https://os-doc-builder.test.mbed.com/docs/development/mbed-os-api-doxy/classrtos_1_1_memory_pool.png)<span>MBRBlockDevice class hierarchy</span></span>
