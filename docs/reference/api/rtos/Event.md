...
[![View code](https://www.mbed.com/embed/?type=library)](http://os-doc-builder.test.mbed.com/docs/v5.9/mbed-os-api-doxy/_event_8h_source.html)
...
- [RTOS configuration](https://os-doc-builder.test.mbed.com/docs/v5.9/reference/configuration-rtos.html).
