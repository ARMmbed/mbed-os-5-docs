 ...
 * [Queue](https://os.mbed.com/docs/v5.4/mbed-os-api-doxy/Queue_8h_source.html)
 * [Mail](https://os.mbed.com/docs/v5.4/mbed-os-api-doxy/Mail_8h_source.html)
...
For more information see [rtos/Mutex.h](https://os.mbed.com/docs/v5.4/mbed-os-api-doxy/Mutex_8h_source.html).
