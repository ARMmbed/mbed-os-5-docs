...
The RTOS provides several mechanisms to move interrupt processing onto a thread. These include, but are not limited to:
 ...
 - <a href="https://os.mbed.com/docs/v5.7/mbed-os-api-doxy/Queue_8h_source.html" target="_blank">Queue</a>.
 - <a href="https://os.mbed.com/docs/v5.7/mbed-os-api-doxy/Mail_8h_source.html" target="_blank">Mail</a>.
...
For more information see <a href="https://os.mbed.com/docs/v5.7/mbed-os-api-doxy/Mutex_8h_source.html" target="_blank">rtos/Mutex.h</a>.
