...
The constructor takes in the NetworkStack pointer to open the socket on the specified NetworkInterface. If the NetworkStack is not passed in constructor, then you must call `open` to initialize the socket.
