...
1. Once connected, you can use Mbed OS [network sockets](https://os-doc-builder.test.mbed.com/docs/development/mbed-os-api-doxy/index.html) as usual.
...
- [Network socket](https://os-doc-builder.test.mbed.com/docs/development/mbed-os-api-doxy/index.html) API reference overview.
