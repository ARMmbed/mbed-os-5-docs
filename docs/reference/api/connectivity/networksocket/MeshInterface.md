...
The Arm Mbed Mesh API allows the application to use the IPv6 mesh network topologies through the [Nanostack](/docs/v5.9/tutorials/mesh.html#nanostack) networking stack.
