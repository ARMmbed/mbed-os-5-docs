...
Arm Mbed BLE, also called `BLE_API`, is the Bluetooth Low Energy software solution for Mbed. Many Mbed <a href="https://os.mbed.com/platforms/?mbed-enabled=15&connectivity=3" target="_blank">targets</a> and <a href="https://os.mbed.com/platforms/?mbed-enabled=15&connectivity=3" target="_blank">components</a> support Mbed BLE. Developers can use it to create new BLE enabled applications.
