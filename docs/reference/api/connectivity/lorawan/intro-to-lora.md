...
Mbed comes with the Arm Mbed Online Compiler, which you can use to build applications without needing to install anything on your computer. (Mbed also has [offline tools](https://os.mbed.com/docs/5.8/tools/index.html)).
...
1. Plug your development board into the computer (over micro-USB) to mount it as a USB mass storage device. In most cases, you do not need a driver, but you can find drivers [here](https://os.mbed.com/docs/5.8/tutorials/windows-serial-driver.html).
...
<span class="notes">**Note 1:** You can hook a [serial monitor](https://os.mbed.com/docs/5.8/tutorials/serial-comm.html) up to the development board (baud rate 115,200) to see debugging messages.</span>
...
- [Mbed OS LoRaWAN stack documentation](https://os.mbed.com/docs/5.8/reference/lorawan.html).
