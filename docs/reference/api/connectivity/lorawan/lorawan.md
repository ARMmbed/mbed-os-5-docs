...
<span class="images">![](https://os.mbed.com/docs/v5.9/mbed-os-api-doxy/class_lo_ra_w_a_n_interface.png)<span>LoRaWANInterface class hierarchy</span></span>
...
The [LoRaWANInterface](https://os.mbed.com/docs/v5.9/mbed-os-api-doxy/class_lo_ra_w_a_n_interface.html) provides a C++ API for connecting to the internet over a LoRa network.

### Usage

To bring up the Mbed LoRaWAN stack, consider the following progression:

1) An [EventQueue](https://os.mbed.com/docs/v5.9/reference/eventqueue.html) object:
...
2) A [LoRaRadio](https://os.mbed.com/docs/v5.9/reference/loraradio-api.html) object:
