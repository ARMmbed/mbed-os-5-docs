...
Partition a heap backed block device into two partitions. You can find the HeapBlockDevice used in this <a href="https://os.mbed.com/docs/v5.6/mbed-os-api-doxy/class_heap_block_device.html" target="_blank">example</a>.
