...
The FileSystem class provides the core user C++ API. Mbed OS provides [File](https://os.mbed.com/docs/v5.9/mbed-os-api-doxy/classmbed_1_1_file.html) and [Dir](https://os.mbed.com/docs/v5.9/mbed-os-api-doxy/classmbed_1_1_dir.html) classes that represent files and directories in a C++ API.
...
- [**FlashSimBlockDevice**](https://github.com/ARMmbed/mbed-os-5-docs/blob/5.9/docs/reference/api/storage/FlashSimBlockDevice.md) - Simulate the behavior of a flash component if the underlying block device doesn't support such behavior.
