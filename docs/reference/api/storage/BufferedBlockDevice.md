...
<span class="images">![](https://os-doc-builder.test.mbed.com/docs/development/mbed-os-api-doxy/class_block_device.html)<span>BufferedBlockDevice class hierarchy</span></span>
