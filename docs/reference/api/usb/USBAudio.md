...
The USBAudio interface is used to send and receive audio across USB. By selecting a USBAudio device as your PC's speaker output you can send audio data. You can also use it as your PC's microphone and receive sound sent by USBAudio.
