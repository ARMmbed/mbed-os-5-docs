...
For more information, see the [documentation of the Socket API](/docs/v5.9/reference/network-socket.html).
...
See [NanostackRfPhy.h](https://github.com/ARMmbed/mbed-os/blob/master/features/nanostack/nanostack-interface/NanostackRfPhy.h) for an up-to-date header file and API.
