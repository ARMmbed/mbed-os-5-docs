...
- An implementation of the [LoRaRadio](https://os.mbed.com/docs/v5.9/mbed-os-api-doxy/class_lo_ra_radio.html) class.
- An implementation of the [LoRaWANBase](https://os.mbed.com/docs/v5.9/mbed-os-api-doxy/class_lo_ra_w_a_n_base.html) class.
...
The [LoRaWANBase](https://os.mbed.com/docs/v5.9/mbed-os-api-doxy/class_lo_ra_w_a_n_base.html) class is a pure virtual class providing user facing APIs for a LoRaWAN stack.
