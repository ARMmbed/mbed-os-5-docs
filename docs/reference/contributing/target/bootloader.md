...
Arm Mbed OS allows you to update your firmware. Our Pelion IoT platform enables this capability. The following documentation includes instructions and examples on how to update firmware on a new target.
