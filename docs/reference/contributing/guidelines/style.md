...
<span class="tips">**Tip:** Please also read the [CLA](/docs/v5.6/reference/guidelines.html#cla) and [workflow](/docs/v5.6/reference/guidelines.html#workflow) sections for a review of the process and legal requirements.</span>

#### Code acceptance

[After the CLA](/docs/v5.6/reference/guidelines.html#cla) is in place and the code has gone through automated testing, developers will take a look and comment on the pull request. If all is well and acceptable, your code will be ready for merging into the central development branch.
