...
By creating a pull request on GitHub, you are agreeing to license your contributions under the same license as the original code.  Note that Mbed software is released under a permissive license  for all new Mbed contributions Arm will not accept proprietary code or any code that is licensed under a "copyleft" license.  Accepting such code would prevent us from continuing to distribute our code under the permissive license and stall adoption of our code by third parties.
