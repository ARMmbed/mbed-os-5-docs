...
The RTOS provides several mechanisms to move interrupt processing onto a thread. These include, but are not limited to:
 ...
 - [Queue](http://os-doc-builder.test.mbed.com/docs/development/mbed-os-api-doxy/classrtos_1_1_queue.html).
 - [Mail](http://os-doc-builder.test.mbed.com/docs/development/mbed-os-api-doxy/classrtos_1_1_mail.html).
...
For more information see [platform/critical.h](http://os-doc-builder.test.mbed.com/docs/development/mbed-os-api-doxy/critical_8h_source.html).
