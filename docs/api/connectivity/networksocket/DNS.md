...
[![View code](https://www.mbed.com/embed/?url=https://github.com/ARMmbed/mbed-os-snippet-DNS_GetHostbyNameAsync/tree/v6.13)](https://github.com/ARMmbed/mbed-os-snippet-DNS_GetHostbyNameAsync/blob/v6.13/main.cpp)
