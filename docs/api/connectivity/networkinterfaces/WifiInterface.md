...
<span class="images">![](http://os.mbed.com/docs/v6.9/mbed-os-api-doxy/class_wi_fi_interface.png)<span>WiFiInterface class hierarchy</span></span>

The WifiInterface provides a simple C++ API for connecting to the internet over a Wi-Fi device.

## Wi-Fi class reference

[![View code](https://www.mbed.com/embed/?type=library)](http://os.mbed.com/docs/v6.9/mbed-os-api-doxy/class_wi_fi_interface.html)
...
[![View code](https://www.mbed.com/embed/?url=https://github.com/ARMmbed/mbed-os-snippet-TCPSocketWiFi/tree/v6.9)](https://github.com/ARMmbed/mbed-os-snippet-TCPSocketWiFi/blob/v6.9/main.cpp)
