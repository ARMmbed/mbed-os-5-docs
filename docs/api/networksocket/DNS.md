...
<span class="images">![](https://os.mbed.com/docs/v5.10/mbed-os-api-doxy/class_d_n_s.png)<span>DNS class hierarchy</span></span>
...
[![View code](https://www.mbed.com/embed/?type=library)](http://os.mbed.com/docs/v5.10/mbed-os-api-doxy/_d_n_s_8h_source.html)
