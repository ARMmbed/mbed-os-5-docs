...
<span class="images">![](http://os.mbed.com/docs/v5.14/mbed-os-api-doxy/classmbed_1_1_block_device.png)<span>BlockDevice class hierarchy</span></span>
...
[![View code](https://www.mbed.com/embed/?type=library)](http://os.mbed.com/docs/v5.14/mbed-os-api-doxy/classmbed_1_1_block_device.html)

## BlockDevice example

[![View code](https://www.mbed.com/embed/?url=https://github.com/ARMmbed/mbed-os-examples-docs_only/blob/v5.14/blockdevices/BlockDevice/)](https://github.com/ARMmbed/mbed-os-examples-docs_only/blob/v5.14/blockdevices/BlockDevice/main.cpp)
