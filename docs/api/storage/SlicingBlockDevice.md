...
<span class="images">![](http://os.mbed.com/docs/v5.14/mbed-os-api-doxy/classmbed_1_1_slicing_block_device.png)<span>SlicingBlockDevice class hierarchy</span></span>
...
[![View code](https://www.mbed.com/embed/?type=library)](http://os.mbed.com/docs/v5.14/mbed-os-api-doxy/classmbed_1_1_slicing_block_device.html)
...
[![View code](https://www.mbed.com/embed/?url=https://github.com/ARMmbed/mbed-os-examples-docs_only/blob/v5.14/blockdevices/SlicingBlockDevice/)](https://github.com/ARMmbed/mbed-os-examples-docs_only/blob/v5.14/blockdevices/SlicingBlockDevice/main.cpp)
