...
<span class="images">![](http://os.mbed.com/docs/v6.10/mbed-os-api-doxy/classmbed_1_1_slicing_block_device.png)<span>SlicingBlockDevice class hierarchy</span></span>
...
[![View code](https://www.mbed.com/embed/?type=library)](http://os.mbed.com/docs/v6.10/mbed-os-api-doxy/classmbed_1_1_slicing_block_device.html)
...
[![View code](https://www.mbed.com/embed/?url=https://github.com/ARMmbed/mbed-os-snippet-SlicingBlockDevice/tree/v6.10)](https://github.com/ARMmbed/mbed-os-snippet-SlicingBlockDevice/blob/v6.10/main.cpp)
