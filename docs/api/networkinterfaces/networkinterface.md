...
- [Mesh networking interface](mesh-api.html): IPv6-based 6LoWPAN_ND.
...
|`*MeshInterface::get_default_instance()` | Returns either `LoWPANNDInterface` | Target provides a driver or macro `DEVICE_802_15_4_PHY` is enabled. |
