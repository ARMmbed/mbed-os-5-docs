...
[![View code](https://www.mbed.com/embed/?url=https://github.com/ARMmbed/mbed-os-snippet-Ticker_HelloWorld/tree/v6.6)](https://github.com/ARMmbed/mbed-os-snippet-Ticker_HelloWorld/blob/v6.6/main.cpp)

## Ticker examples

Use this example to attach a member function to a ticker:

[![View code](https://www.mbed.com/embed/?url=https://github.com/ARMmbed/mbed-os-snippet-Ticker_Example/tree/v6.6)](https://github.com/ARMmbed/mbed-os-snippet-Ticker_Example/blob/v6.6/main.cpp)
