...
[![View code](https://www.mbed.com/embed/?url=https://github.com/ARMmbed/mbed-os-snippet-PlatfromOverview_Callbacks/tree/v6.12)](https://github.com/ARMmbed/mbed-os-snippet-PlatfromOverview_Callbacks/blob/v6.12/main.cpp)
