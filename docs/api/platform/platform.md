...
[![View code](https://www.mbed.com/embed/?url=https://github.com/ARMmbed/mbed-os-snippet-PlatfromOverview_Callbacks/tree/v6.10)](https://github.com/ARMmbed/mbed-os-snippet-PlatfromOverview_Callbacks/blob/v6.10/main.cpp)
