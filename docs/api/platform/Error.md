...
[![View code](https://www.mbed.com/embed/?type=library)](https://os.mbed.com/docs/v5.10/mbed-os-api-doxy/mbed__error_8h_source.html)
...
- Debug and develop [build profiles](/docs/v5.10/tools/build-profiles.html).
