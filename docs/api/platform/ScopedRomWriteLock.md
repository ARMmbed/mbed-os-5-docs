...
<span class="images">![](https://os.mbed.com/docs/mbed-os/v6.15/mbed-os-api-doxy/classmbed_1_1_scoped_rom_write_lock.png)<span>ScopedRomWriteLock class hierarchy</span></span>
...
[![View code](https://www.mbed.com/embed/?type=library)](http://os.mbed.com/docs/v6.15/mbed-os-api-doxy/classmbed_1_1_scoped_rom_write_lock.html)

## Example

This example shows how you can enable writes to ROM from main.

[![View code](https://www.mbed.com/embed/?url=https://github.com/ARMmbed/mbed-os-snippet-ScopedRomWriteLock/tree/v6.15)](https://github.com/ARMmbed/mbed-os-snippet-ScopedRomWriteLock/blob/v6.15/main.cpp)
