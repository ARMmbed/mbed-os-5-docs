...
[![View code](https://www.mbed.com/embed/?type=library)](https://os.mbed.com/docs/v5.10/mbed-os-api-doxy/mbed__assert_8h_source.html)
...
Note that the `MBED_ASSERT` macro is available in the debug and develop [build profiles](/docs/v5.10/tools/build-profiles.html) but not in the release build profile.
...
- [Build profile](/docs/v5.10/tools/build-profiles.html) documentation.
