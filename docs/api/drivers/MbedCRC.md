...
[![View code](https://www.mbed.com/embed/?type=library)](https://os.mbed.com/docs/mbed-os/v6.4/mbed-os-api-doxy/structcrc__mbed__config.html)
...
[![View code](https://www.mbed.com/embed/?url=https://github.com/ARMmbed/mbed-os-snippet-CRC_ex_1/tree/v6.4)](https://github.com/ARMmbed/mbed-os-snippet-CRC_ex_1/blob/v6.4/main.cpp)

### Example 2

Below is a 32-bit CRC example using `compute_partial` APIs.

[![View code](https://www.mbed.com/embed/?url=https://github.com/ARMmbed/mbed-os-snippet-CRC_ex_2/tree/v6.4)](https://github.com/ARMmbed/mbed-os-snippet-CRC_ex_2/blob/v6.4/main.cpp)

### Example 3

Below is a CRC example for the SD driver.

[![View code](https://www.mbed.com/embed/?url=https://github.com/ARMmbed/mbed-os-snippet-CRC_ex_3/tree/v6.4)](https://github.com/ARMmbed/mbed-os-snippet-CRC_ex_3/blob/v6.4/main.cpp)
